    ...
    const content = [
        {
            ...
            videoSrc: "../port/assets/effects.MOV",
            imgSrc: "../port/assets/мак.png",
        },
        {
            number: "02",
            title: "Mobile - App",
            description: "Мобильное приложение на основе КАИ.",
            videoSrc: "../port/assets/moove.mov",
            imgSrc: "../port/assets/phone.png",
        },
        {
            number: "03",
            title: "tWitteR - clone",
            description: "Микросервис - с функционалом твиттера.",
            videoSrc: "../port/assets/coding.MOV",
            imgSrc: "../port/assets/мак.png",
        },
        {
            number: "04",
            ...
            videoSrc: "../port/assets/Itachi-Uchiha-Moonlight-Killer.mp4",
            imgSrc: "../port/assets/phone.png",
        },
        {
            number: "05",
